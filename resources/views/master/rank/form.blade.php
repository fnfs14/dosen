                                ...
                                <div class="row">
                                    <div class="col-md-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control focus:border-emerald-300-important focus:ring focus:ring-emerald-100 {{ $errors->has('name') ? 'border-red-700-important' : '' }}" id="name" value="{{ old('name',@$data->name) }}" placeholder="Nama Pangkat" required>
