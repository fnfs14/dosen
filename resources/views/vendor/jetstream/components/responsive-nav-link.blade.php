...
$classes = ($active ?? false)
            ? 'block pl-3 pr-4 py-2 border-l-4 border-emerald-400 text-base font-medium text-emerald-700 bg-emerald-50 focus:outline-none focus:text-emerald-800 focus:bg-emerald-100 focus:border-emerald-700 transition'
