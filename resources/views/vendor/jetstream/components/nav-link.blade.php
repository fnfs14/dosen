...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 hover:text-emerald-600 border-emerald-400 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-emerald-700 transition'
